...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'כן. שירות אירועי החוץ של הדרומית מגיע אליכם בדרום ובמרכז עם בשרים ומנות מהמסעדה, מנגל במקום ועמדות הגשה. פרטים בעמוד אירועי חוץ.',
    category: 'אירועים'
  },
  {
    question: 'מה כולל שירות אירועי החוץ?',
    answer: 'צוות הדרומית מגיע למיקום האירוע עם בשרים כשר חלק, מנות מהמסעדה ומנגל במקום. מתאים לאירועי שטח, בריכה, גינה, אירועים עסקיים וארגונים.',
    category: 'אירועים'
  },
  {
    question: 'לאילו אזורים אתם מגיעים באירועי חוץ?',
    answer: 'אנחנו מגיעים לאירועי חוץ בדרום ובמרכז הארץ. שלחו את מיקום האירוע ונאשר זמינות והגעה.',
    category: 'אירועים'
  },
