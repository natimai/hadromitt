  ...
  const additionalSections = [
    {
      ...
      content: "אנו עשויים לשלוח לכם תכנים שיווקיים בדוא"ל או ב-SMS, בכפוף להסכמתכם. תוכלו לבטל את הסכמתכם בכל עת באמצעות הקישור המצורף להודעות או באמצעות פנייה אלינו."
    },
    {
      title: "שיתוף מידע",
