  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gradient-to-b from-[#1A0000] to-black">
      ...
      >
          ...
          {isLoaded &&
            ...
            >
              <motion.div 
                initial={{ scale: 1.05 }}
                animate={{ 
                  scale: isHoveringHero ? 1.02 : 1.05,
        ...
        <div className="relative min-h-screen flex flex-col items-center text-white px-4">
          ...
          <div className="mt-10 sm:mt-0 flex-grow flex flex-col justify-center items-center">
            <motion.div
              ...
              className="space-y-8 md:space-y-16 max-w-4xl mx-auto text-center"
            >
              <motion.div
                className="relative"
              ...
              >
                <Link to="/" aria-label="לוגו הדרומית">
                  <div className="relative">
                    ...
                    />
                    <div className="relative p-8 bg-black/40 backdrop-blur-xl rounded-[30px] border border-white/20 shadow-2xl">
                      <motion.img 
                        src="/logo.svg"
                        alt="לוגו הדרומית"
              ...
              >
                ...
                <motion.div
                  className="relative h-8 md:h-12 overflow-hidden"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
              ...
              >
                <a
                  ...
                  className="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-medium rounded-full transition duration-300 ease-out border-2 border-[#FF0000] text-white shadow-md"
                ...
                <a
                  href="tel:0796744711"
                  className="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-medium rounded-full transition duration-300 ease-out border-2 border-white text-white shadow-md"
